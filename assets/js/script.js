  ...
  const item = [
    ...
    },
    {
      ...
      hash: [
        ...
        "transformOrigin",
        "stagger.repeatDelay",
        "stagger repeatDelay = stagger * (numberOfTargets - 1) + pause;",
      ],
    },
  ];
  setItem(area, item);
  ...
  const item = [
    {
      ...
      hash: [
        "gsap.utils.mapRange()",
        "중복된 트윈을 지속적으로 만들어야 할 때는 gsap.quickTo() 사용하는게 좋다",
        "x-ray 효과",
      ],
    },
    {
    ...
    },
    {
      ...
      hash: [
        "gsap.utils.distribute({}): 값을 알아서 분배해준다.",
        "base",
        "amount",
        "ease",
        "stagger",
  ...
  const item = [
    {
      ...
      hash: [
        "몇 초 뒤에 다른 함수를 호출해야 될 경우",
        "setTimeout과 유사하지만 다름",
        "addPause()",
      ],
    },
    {
