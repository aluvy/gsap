...
!(function (e, t) {
	...
	function ScrollSmoother(t) {
		...
		function fb(r, e, t, n, o) {
			function qc() {
				(e = u()), (t = parseFloat(d().value)), (i = parseFloat(e.value) || 1), (a = 'auto' === e.value), (c = a || (s && s._startClamp && s.start <= 0) || p.offset ? 0 : s && s._endClamp && s.end === D() ? 1 : 0.5), l && l.kill(), (l = t && B.to(r, { ease: $, overwrite: !1, y: '+=0', duration: t })), s && ((s.ratio = i), (s.autoSpeed = a));
			}
			function rc() {
				...
				if (a) {
					...
					var t = (function _autoDistance(e, t) {
						var r,
							...
							f = -c * t;
						return 0 < c && ((n = 0.5 == (r = s.height / (L.innerHeight + s.height)) ? 2 * s.height : 2 * Math.min(s.height, Math.abs((-c * r) / (2 * r - 1))) * (t || 1)), (f += t ? -n * t : -n / 2), (c += n)), { change: c, offset: f };
		...
		V.forEach(function (e) {
			...
			(i = Z.create({
				...
				onRefresh: function onRefresh(e) {
					e.animation.invalidate(), e.setPositions(e.start, refreshHeight() / A), d || Ta(e), (z.y = -E() * A), Ua(z.y), N || (d && (g = !1), e.animation.progress(B.utils.clamp(0, 1, u / A / -e.end))), d && ((e.progress -= 0.001), e.update()), (ScrollSmoother.isRefreshing = !1);
				},
				id: 'ScrollSmoother',
				scroller: L,
